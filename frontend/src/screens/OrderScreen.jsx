        ...
        <Col md={8}>
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              <p> <strong>رقم الهاتف: </strong> {order.shippingAddress.phoneNum},{' '} </p>
              <p>
              ...
              {order.isDelivered ? (
                <Message variant='success'>
                  تم التسليم في {order.deliveredAt}
                </Message>
              ) : (
                <Message variant='danger'>لم يتم التسليم</Message>
              )}
            </ListGroup.Item>
